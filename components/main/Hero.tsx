  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-wrap items-center">
        ...
        >
          <div className="relative w-[250px] h-[250px] md:w-[400px] md:h-[400px] rounded-full overflow-hidden bg-[#ffffff08] backdrop-blur-[12px] border-2 border-[#645AFF] flex justify-center items-center shadow-md shadow-[#645AFF]/70">
            <Image
              src="/ramanbild.png"
