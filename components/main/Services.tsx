  ...
  return (
    ...
    >
      ...
      <div className="container lg:flex mx-auto">
        ...
        >
          <p className="mb-4 Welcome-text md:mb-16 lg:mb-32 font-semibold lg:w-[22rem] lg:mx-auto">
          ...
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-gray-800 rounded-full -translate-x-1/2 scale-75 md:scale-100">
            ...
            <div className="hidden absolute top-1/2 right-full w-[32.625rem] -mt-1 mr-24 pointer-events-none xl:block">
