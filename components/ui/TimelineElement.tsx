...
const TimelineElement = ({ id, type, date, title, location, description }: TimelineItemProps) => {
  ...
  return (
    <VerticalTimelineElement
      ...
      key={id}
      date={date}
      contentStyle={{ background: 'rgba(33, 150, 243, 0.1)', color: '#fff', boxShadow: '0 3px 5px 2px rgba(0, 0, 0, .3)' }}
